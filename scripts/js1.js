...
(t = this),
  (e = function () {
    ...
    function s() {
      ...
      return (
        1 === t.length
          ? n(t[0]) || Array.isArray(t[0])
            ? (i = t[0])
            : "string" == typeof t[0] && (r = t[0])
          : 2 === t.length &&
            ("string" == typeof t[0] && (r = t[0]),
            (n(t[1]) || Array.isArray(t[1])) && (i = t[1])),
        { locale: r, params: i }
      );
    }
    function l(t) {
    ...
    function f(t) {
      for (var e = arguments, r = Object(t), i = 1; i < arguments.length; i++) {
        var a = e[i];
        if (null != a) {
          var o = void 0;
          for (o in a)
            u(a, o) && (n(a[o]) ? (r[o] = f(r[o], a[o])) : (r[o] = a[o]));
        }
      }
      return r;
    }
    function h(t, e) {
      ...
      var r = n(t),
        i = n(e);
      if (!r || !i) return !r && !i && String(t) === String(e);
      try {
    ...
    var p,
      m = {
        beforeCreate: function () {
          ...
          if (((t.i18n = t.i18n || (t.__i18n ? {} : null)), t.i18n)) {
            ...
            this.$root && this.$root.$i18n && this.$root.$i18n instanceof Z
              ? (this._i18n = this.$root.$i18n)
              : t.parent &&
                t.parent.$i18n &&
                t.parent.$i18n instanceof Z &&
      ...
      _ = {
        ...
        render: function (t, e) {
          ...
          var o = n.path,
            ...
            c = n.places || {},
            u =
              (Array.isArray(c) ? c.length : Object.keys(c).length,
              i.every(function (t) {
      ...
      g = {
        ...
        render: function (e, r) {
          ...
          var l = null,
            c = null;
          "string" == typeof i.format
            ? (l = i.format)
            : n(i.format) &&
              (i.format.key && (l = i.format.key),
              (c = Object.keys(i.format).reduce(function (e, n) {
                var r;
                return t.includes(n)
                  ? Object.assign({}, e, (((r = {})[n] = i.format[n]), r))
                  : e;
              }, null)));
          var u = i.locale || s.locale,
            f = s._ntp(i.value, u, l, c),
    ...
    function w(t, n, r) {
      ...
      if (l || c || u)
        if (l) {
          ...
          (t._vt = t.textContent =
            f
              ? (i = h.$i18n).tc.apply(i, [l, f].concat($(c, u)))
              : (o = h.$i18n).t.apply(o, [l].concat($(c, u)))),
    ...
    function k(t) {
      ...
      !(function (t) {
        ...
        p.mixin(m),
        p.directive("t", { bind: v, update: y, unbind: b }),
        p.component(_.name, _),
        p.component(g.name, g),
    ...
    F.prototype.interpolate = function (t, e) {
      ...
      return (
            ...
            for (; n < t.length; ) {
              ...
              if ("{" === i) {
                ...
                for (i = t[n++]; void 0 !== i && "}" !== i; )
                  (a += i), (i = t[n++]);
                var o = "}" === i,
                  s = M.test(a) ? "list" : o && D.test(a) ? "named" : "unknown";
        ...
        (function (t, e) {
          var r = [],
            i = 0,
            a = Array.isArray(e) ? "list" : n(e) ? "named" : "unknown";
    ...
    var M = /^(?:\d)+/,
      ...
      N = 8,
      S = [];
    (S[O] = { ws: [O], ident: [3, L], "[": [C], eof: [A] }),
      (S[1] = { ws: [1], ".": [2], "[": [C], eof: [A] }),
      (S[2] = { ws: [2], ident: [3, L], 0: [3, L], number: [3, L] }),
      (S[3] = {
        ident: [3, L],
        0: [3, L],
        number: [3, L],
      ...
      (S[j] = { "'": [C, L], eof: N, else: [j, L] }),
      (S[W] = { '"': [C, L], eof: N, else: [W, L] });
    ...
    function V(t) {
      ...
      return (
        ...
        ((r = i),
        H.test(r)
          ? (n = (e = i).charCodeAt(0)) !== e.charCodeAt(e.length - 1) ||
            (34 !== n && 39 !== n)
            ? e
            : e.slice(1, -1)
          : "*" + i)
    ...
    (E.prototype.parsePath = function (t) {
        ...
        e ||
          ((e = (function (t) {
            ...
            for (
              ...
              if ("\\" !== (e = t[++c]) || !p()) {
                if (((i = R(e)), (a = (s = S[u])[i] || s.else || N) === N))
                  return;
                if (
                  ((u = a[0]),
                  (o = h[a[1]]) &&
                    ((r = void 0 === (r = a[2]) ? e : r), !1 === o()))
                )
                  return;
                if (u === A) return l;
              }
      ...
      (E.prototype.getPathValue = function (t, e) {
        if (!n(t)) return null;
    ...
    var P,
      ...
      Z = function (t) {
        var e = this;
        void 0 === t && (t = {}),
          !p && "undefined" != typeof window && window.Vue && k(window.Vue);
        ...
        (this._vm = null),
          ...
          (this._exist = function (t, n) {
            return !(!t || !n) && (!o(e._path.getPathValue(t, n)) || !!t[n]);
          }),
    ...
    return (
      (Z.prototype._checkLocaleMessage = function (t, n, r) {
        var i = function (t, n, r, o) {
          if (a(r))
            Object.keys(r).forEach(function (e) {
              var s = r[e];
              a(s)
                ? (o.push(e), o.push("."), i(t, n, s, o), o.pop(), o.pop())
                : (o.push(e), i(t, n, s, o), o.pop());
            });
      ...
      (Z.prototype._initVM = function (t) {
        var e = p.config.silent;
        (p.config.silent = !0),
          (this._vm = new p({ data: t })),
          (p.config.silent = e);
      }),
      ...
      (Z.prototype._warnDefault = function (t, e, n, r, i) {
        if (!o(n)) return n;
        if (this._missing) {
      ...
      (Z.prototype._isFallbackRoot = function (t) {
        return !t && !o(this._root) && this._fallbackRoot;
      }),
      (Z.prototype._isSilentFallback = function (t) {
        return (
          this._silentFallbackWarn &&
          (this._isFallbackRoot() || t !== this.fallbackLocale)
        );
      }),
      (Z.prototype._interpolate = function (t, e, n, r, i, s, l) {
        if (!e) return null;
        var c,
          u = this._path.getPathValue(e, n);
        if (Array.isArray(u) || a(u)) return u;
        if (o(u)) {
          if (!a(e)) return null;
        ...
        return (
          (c.indexOf("@:") >= 0 || c.indexOf("@.") >= 0) &&
            (c = this._link(t, e, c, r, "raw", s, l)),
          this._render(c, i, s, n)
        );
      }),
      (Z.prototype._link = function (t, e, n, r, i, a, o) {
        var s = n,
          l = s.match(J);
        for (var c in l)
          if (l.hasOwnProperty(c)) {
            ...
            (_ = this._warnDefault(t, m, _, r, Array.isArray(a) ? a : [a])),
              G.hasOwnProperty(p) && (_ = G[p](_)),
              o.pop(),
              (s = _ ? s.replace(u, _) : s);
          }
        return s;
      ...
      (Z.prototype._render = function (t, e, n, r) {
        ...
        return (
          i || (i = X.interpolate(t, n, r)), "string" === e ? i.join("") : i
        );
      }),
      (Z.prototype._translate = function (t, e, n, r, i, a, s) {
        var l = this._interpolate(e, t[e], r, i, a, s, [r]);
        return o(l) && o((l = this._interpolate(n, t[n], r, i, a, s, [r])))
          ? null
          : l;
      }),
      (Z.prototype._t = function (t, e, n, r) {
        ...
        return this._warnDefault(c, t, u, r, a);
      }),
      ...
      (Z.prototype._i = function (t, e, n, r, i) {
      ...
      (Z.prototype.getChoiceIndex = function (t, e) {
        var n, r;
        return this.locale in this.pluralizationRules
          ...
          : ((n = t),
            (r = e),
            (n = Math.abs(n)),
            2 === r ? (n ? (n > 1 ? 1 : 0) : 1) : n ? Math.min(n, 2) : 0);
      }),
      ...
      (Z.prototype._te = function (t, e, n) {
        for (var r = [], i = arguments.length - 3; i-- > 0; )
          r[i] = arguments[i + 3];
        var a = s.apply(void 0, r).locale || e;
      ...
      (Z.prototype.mergeLocaleMessage = function (t, e) {
        (("warn" !== this._warnHtmlInMessage &&
          ...
          (this._checkLocaleMessage(t, this._warnHtmlInMessage, e),
          "error" !== this._warnHtmlInMessage)) &&
          this._vm.$set(this._vm.messages, t, f(this._vm.messages[t] || {}, e));
      }),
      ...
      (Z.prototype.mergeDateTimeFormat = function (t, e) {
        this._vm.$set(
          ...
          t,
          f(this._vm.dateTimeFormats[t] || {}, e)
        );
      }),
      (Z.prototype._localizeDateTime = function (t, e, n, r, i) {
        var a = e,
          s = r[a];
        if (((o(s) || o(s[i])) && (s = r[(a = n)]), o(s) || o(s[i])))
          return null;
        var l = s[i],
          c = a + "__" + i,
        ...
        return (
          1 === e.length
            ? "string" == typeof e[0]
              ? (a = e[0])
              : n(e[0]) &&
                (e[0].locale && (i = e[0].locale), e[0].key && (a = e[0].key))
            : 2 === e.length &&
              ("string" == typeof e[0] && (a = e[0]),
      ...
      (Z.prototype.mergeNumberFormat = function (t, e) {
        this._vm.$set(
          ...
          t,
          f(this._vm.numberFormats[t] || {}, e)
        );
      }),
      (Z.prototype._getNumberFormatter = function (t, e, n, r, i, a) {
        var s = e,
          l = r[s];
        if (((o(l) || o(l[i])) && (l = r[(s = n)]), o(l) || o(l[i])))
          return null;
        var c,
          u = l[i];
        if (a) c = new Intl.NumberFormat(s, Object.assign({}, u, a));
        else {
          var f = s + "__" + i;
          (c = this._numberFormatters[f]) ||
            (c = this._numberFormatters[f] = new Intl.NumberFormat(s, u));
        }
        return c;
      }),
        ...
        return (
          1 === r.length
            ? "string" == typeof r[0]
              ? (o = r[0])
              : n(r[0]) &&
                (r[0].locale && (a = r[0].locale),
                r[0].key && (o = r[0].key),
                (s = Object.keys(r[0]).reduce(function (e, n) {
                  var i;
                  return t.includes(n)
                    ? Object.assign({}, e, (((i = {})[n] = r[0][n]), i))
                    : e;
                }, null)))
            : 2 === r.length &&
              ("string" == typeof r[0] && (o = r[0]),
              "string" == typeof r[1] && (a = r[1])),
          this._n(e, a, o, s)
        );
      }),
      ...
      Object.defineProperty(Z, "availabilities", {
        get: function () {
          if (!P) {
...
var CommonMixin = {
  ...
  created: function () {
    ...
    this.user =
      window.SHARED_DATA && window.SHARED_DATA.user
        ? window.SHARED_DATA.user
        : null;
    this.lang =
      window.SHARED_DATA && window.SHARED_DATA.locale
        ? window.SHARED_DATA.locale
        : window.locale;
  ...
  methods: {
    ...
    getGlobalLink: function (link) {
      if (
        window.SHARED_DATA &&
        window.SHARED_DATA.links &&
        window.SHARED_DATA.links[link]
      ) {
    ...
    __e: function (key, arg1, arg2, arg3) {
      ...
      if (arg1) {
        text = text.replace("{0}", arg1);
      }
      if (arg2) {
        text = text.replace("{1}", arg2);
      }
      if (arg3) {
        text = text.replace("{2}", arg3);
      }
...
var UpgradeMixin = {
  data: {
    upgrade_modal: {
      plans:
        window.SHARED_DATA && window.SHARED_DATA.available_plans
          ? window.SHARED_DATA.available_plans
          : [],
  ...
  methods: {
    ...
    onUpgradeModalSwitchDuration: function () {
      ...
      var find = this.upgrade_modal.plans.find(function (p) {
        return (
          p.slug === current_plan_slug &&
          p.type !== _this.upgrade_modal.active_plan.type
        );
      });
      if (find) {
    ...
    showAppSumoUpgrade: function () {
      $("#upgradeModalExternalVendor").modal({
        backdrop: "static",
        keyboard: true,
      });
    },
    ...
    showSubscriptionUpgradeModal(targeted_comments, feature, app_type, config) {
      if (
        ...
        this.user.subscription.vendor === "appsumo"
      ) {
      ...
      // if (!this.user || this.user.subscription.plan_id === 1) {
      // this.upgrade_modal.experiment_version = (typeof window.free_user_experiment_version !== 'undefined') ? window.free_user_experiment_version : null;

      // if (this.upgrade_modal.experiment_version) {
      // 	this.upgrade_modal.show_countdown = true;
      // 	upgrade_countdown_timer = localStorage.getItem('upgrade_countdown');
      // 	if (upgrade_countdown_timer) {
      // 		this.upgrade_modal.countdown_start = parseInt(upgrade_countdown_timer);
      // 		let time_left = this.upgrade_modal.countdown_start - Date.now();
      // 		if (time_left < 0) {
      // 			this.upgrade_modal.show_countdown = false;
      // 			this.upgrade_modal.experiment_version = undefined;
      // 		}
      // 	} else {
      // 		this.upgrade_modal.countdown_start = Date.now() + 17 * 60 * 1000;
      // 		localStorage.setItem('upgrade_countdown', this.upgrade_modal.countdown_start);
      // 	}
      // 	this.refreshCoundown();
      // }
      // }

      this.__setTargetedPlan(targeted_comments, feature);
      (this.user_current_plan =
        this.user && this.user.subscription && this.user.subscription.plan
          ? this.user.subscription.plan.slug
          : null),
      ...
      this.upgrade_modal.custom_title =
        config && config.custom_title ? config.custom_title : false;
      this.upgrade_modal.custom_text =
        config && config.custom_text ? config.custom_text : false;

      if (config && config.features_page) {
        this.upgrade_modal.features_page = config.features_page;
      ...
      mixpanel.track("AS_ShowedSubscriptionUpgrade", {
        feature: feature,
        plan:
          this.upgrade_modal.active_plan.name_long +
          " [" +
          this.upgrade_modal.active_plan.features.INSTAGRAM_COMMENTS_LIMIT +
          "]",
        plan_limit:
          this.upgrade_modal.active_plan.features.INSTAGRAM_COMMENTS_LIMIT,
    ...
    getPlanClass: function (plan) {
      ...
      return {
        ...
        disabled: parseInt(limit) < this.upgrade_modal.target_comments_limit,
    ...
    refreshCoundown: function () {
      ...
      if (time_left <= 0) {
        ...
        if (document.getElementById("upgrade_countdown")) {
          document.getElementById("upgrade_countdown").textContent = `${
            minutos < 10 ? "0" : ""
          }${minutos}:${segundos < 10 ? "0" : ""}${segundos}`;
        }
        if (!window.upgrade_modal_countdown_timer) {
          window.upgrade_modal_countdown_timer = setInterval(
            this.refreshCoundown,
            1000
          );
        }
...
var MyAccount = {};
MyAccount.onDelete = function (e) {
  e.preventDefault();
  $(".js-delete-account-btn").hide();
  $(".js-delete-account-confirm").show();
};
MyAccount.onDeleteCancelled = function (e) {
  e.preventDefault();
  $(".js-delete-account-btn").show();
  $(".js-delete-account-confirm").hide();
};
...
ManageDrawPage.downloadCertVideo = function (id) {
  ...
  $.get(
    "https://certs.app-sorteos.com/video.php?id=" + id + "&v=1",
    function (response) {
      if (response && response.data && response.status == true) {
        window.saveAs(
          "https://certs.app-sorteos.com/tmp/" + response.data.filename,
          response.data.filename
        );
        setTimeout(function () {
          $("#js-download-video-btn")
            .removeClass("loading")
            .prop("disabled", false);
        }, 1500);
      }
...
var calculateHeroPosition = function () {
  ...
  if ($hero) {
    ...
    window.hero_end_position =
      hero_position.y + hero_position.height + 50 + window.pageYOffset;
...
var initShareButtons = function () {
  var $sticky_share_buttons = document.getElementsByClassName(
