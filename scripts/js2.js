Vue.component("app-media-gallery", {
  ...
  methods: {
    ...
    onSearch: function () {
      ...
      $.ajax({
        url:
          "https://api.unsplash.com/search/photos?page=1&client_id=kkMkKNh0WZ0i8ZBmplWy3yHSJc3ZCMrg_I-FDC_EOFI&per_page=30&query=" +
          q,
        type: "GET",
    ...
    downloadImage: function (image) {
      ...
      $.ajax({
        url:
          ...
          "?client_id=kkMkKNh0WZ0i8ZBmplWy3yHSJc3ZCMrg_I-FDC_EOFI",
        type: "GET",
...
Vue.component("app-signup", {
  ...
  methods: {
    ...
    onSwitchTab: function (tab) {
      ...
      if (tab === "signin") {
        this.onFocusOnInput("signin_email_input");
      }
    },
    ...
    facebookSignInCallback: function () {
      ...
      setTimeout(() => {
        if (
          window.facebook_login_window &&
          window.facebook_login_window.closed
        ) {
        ...
        try {
          ...
          if (
            window.facebook_login_window &&
            window.facebook_login_window.location &&
            window.facebook_login_window.location.href.indexOf(
              "app-sorteos"
            ) !== -1
          ) {
...
function rando(a, b, e) {
  ...
  function d(a) {
    return !f(a) && null !== a && a.constructor === Array;
  }
  try {
    if (null !== a && null !== b && null !== e) {
      if (f(a)) return Math.random();
      if (window.jQuery && a instanceof jQuery && f(b)) {
        if (0 == a.length) return !1;
        var c = rando(0, a.length);
        return { index: c, value: a.eq(c) };
      }
      if (
        h(a) &&
        h(b) &&
      ...
      if (d(a) && 0 < a.length && f(b)) {
        var g = Math.floor(Math.random() * a.length);
        return { index: g, value: a[g] };
      }
      if ("object" === typeof a && f(b)) {
        g = a;
        var l = Object.keys(g);
        if (0 < l.length) {
          var m = l[(l.length * Math.random()) << 0];
          return { key: m, value: g[m] };
        }
      }
      if (((!0 === a && !1 === b) || (!1 === a && !0 === b)) && f(e))
        return 0.5 < rando();
      if (h(a) && f(b)) return 0 <= a ? rando(0, a) : rando(a, 0);
      if (
        h(a) &&
        "string" === typeof b &&
      ...
      if ("string" === typeof a && 0 < a.length && f(b))
...
function randoSequence(a, b) {
  ...
  function h(a) {
    return !e(a) && null !== a && a.constructor === Array;
  }
  try {
...
iqwerty.toast = (function () {
  ...
  Toast.prototype.initializeAnimations = function () {
    ...
    style.innerHTML =
      "." +
      iqwerty.toast.identifiers.CLASS_SLIDE_IN +
      "{opacity: 1; bottom: 10%;}" +
      "." +
      ...
      "{transition: opacity " +
      iqwerty.toast.style.TOAST_ANIMATION_SPEED +
      "ms, bottom " +
      iqwerty.toast.style.TOAST_ANIMATION_SPEED +
      "ms;}";
  ...
  Toast.prototype.show = function () {
    ...
    this.getToastStage().classList.add(
      iqwerty.toast.identifiers.CLASS_ANIMATED
    );
    this.getToastStage().classList.add(
      iqwerty.toast.identifiers.CLASS_SLIDE_OUT
    ...
    this.getToastStage().classList.remove(
      iqwerty.toast.identifiers.CLASS_SLIDE_OUT
    );
